...
namespace ClientUI
{
    public partial class login : System.Web.UI.Page
    {
        ...
        protected async void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            //  HttpResponseMessage response = await _client.PostAsync("http://localhost:54213/api/authenticate/login", contentData);
            HttpResponseMessage response = await _client.PostAsync("https://auditorapi.azurewebsites.net/api/authenticate/login", contentData);
        ...
        private async void GetUserID(string username, string token)
        {
            ...
            HttpResponseMessage response = await _client.GetAsync("https://auditorapi.azurewebsites.net/api/AuditorPortfolios/GetUserDetails/" + username.ToString());

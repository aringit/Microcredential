...
namespace JWTAuthentication
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           services.AddDbContext<JWTAuthentication.Models.AuditorDBContext>(options => options.UseSqlServer("Server=tcp:microauclidb.database.windows.net,1433;Initial Catalog=AuditorDB;Persist Security Info=False;User ID=cog;Password=arin@123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"));
